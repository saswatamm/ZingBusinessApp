...
data class OrderCustomerModel(
    ...
    var details:OrderCustomerModelDetails?=OrderCustomerModelDetails(),
//    var details:ArrayList<OrderCustomerModelDetails> = arrayListOf(),

)
data class OrderCustomerModelDetails(
