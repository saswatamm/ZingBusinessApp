...
-keep class * extends androidx.lifecycle.ViewModel {
    <init>(androidx.lifecycle.ViewModelStoreOwner);
}

-keep class * extends androidx.lifecycle.ViewModel {
    <init>(androidx.lifecycle.ViewModelStoreOwner, android.os.Bundle);
}
...
-keep class * extends androidx.lifecycle.ViewModel {
    <init>(androidx.lifecycle.SavedStateHandle, android.os.Bundle);
}

-keep class * extends androidx.lifecycle.ViewModel {
    <init>(androidx.lifecycle.ViewModelStoreOwner, androidx.lifecycle.SavedStateHandle);
}

-keep class * extends androidx.lifecycle.ViewModel {
    <init>(androidx.lifecycle.ViewModelStoreOwner, androidx.lifecycle.SavedStateHandle, android.os.Bundle);
}

-keep class * extends androidx.lifecycle.ViewModel {
    <init>(androidx.lifecycle.ViewModelStoreOwner, androidx.lifecycle.SavedStateHandle, android.app.Application);
}
